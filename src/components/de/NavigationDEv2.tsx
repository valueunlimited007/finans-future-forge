...
const NavigationDEv2 = () => {
  ...
  const loanProducts = [
    ...
    },
    {
      ...
      href: "/ratenkredit/ohne-schufa",
      description: "Kredite ohne Schufa-Prüfung",
      icon: TrendingUp
    },
    {
  ...
  const resources = [
    ...
    },
    {
      title: "Über uns",
      href: "/uber-uns",
      description: "Mehr über Finanzen-Guide",
      icon: Users
    }
  ];
                ...
                <div className="grid gap-3 p-6 w-[500px]">
                  <div className="grid gap-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Finden Sie den besten Kredit für Ihre Situation
                    </p>
                  </div>
            ...
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <div className="grid gap-3 p-6 w-[550px]">
                  <div className="grid gap-1">
                    <h3 className="font-medium">Beliebte Ratgeber</h3>
                    <p className="text-sm text-muted-foreground">
              ...
              <div className="flex flex-col px-6 pb-20 space-y-6">
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-muted-foreground">Übersicht und Neuigkeiten</p>
                  </div>
                  {isActivePath("/") && (
                    <div className="h-2 w-2 rounded-full bg-primary flex-shrink-0" />
                  )}
