  ...
  return (
    ...
    >
      <div className="container flex h-[80px] sm:h-[96px] md:h-[112px] lg:h-[128px] items-center justify-between px-4 min-w-full">
        <Link to="/" className="flex flex-col sm:flex-row sm:items-center shrink-0 gap-1 sm:gap-3">
          <img 
            src={siteConfig.logo} 
            alt={siteConfig.name}
            className="h-8 sm:h-10 md:h-12 lg:h-14 w-auto"
          />
          <span className="text-[11px] leading-tight sm:text-xs md:text-sm text-muted-foreground max-w-[200px] sm:max-w-none">
