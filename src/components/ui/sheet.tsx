...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    style={{ zIndex: 99999 }}
    className={cn(
      "fixed inset-0 bg-black/50 transition-opacity data-[state=closed]:opacity-0 data-[state=open]:opacity-100 data-[state=closed]:duration-200 data-[state=open]:duration-200",
      className
    )}
    {...props}
    ref={ref}
...
const sheetVariants = cva(
  "fixed gap-4 bg-background p-6 shadow-lg transition-transform ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-200",
  {
    variants: {
      side: {
